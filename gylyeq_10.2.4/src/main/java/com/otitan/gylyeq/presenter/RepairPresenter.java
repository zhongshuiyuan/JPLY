...
public class RepairPresenter {
    ...
    /**一条path时小班修改保存*/
    public GeodatabaseFeature saveXBoPathFeature(Polyline drawline, Polygon selectPpolygon) {
        GeodatabaseFeature refeature = null;
        ...
        if (jdsize > 2) {
            ...
            refeature = basePresenter.updateFeature(polygon, BaseActivity.selGeoFeature, BaseActivity.myLayer);
            ...
            if (nodestar && nodeend) {// 此时两点在多边形内
                ...
                refeature = basePresenter.updateFeature(geometry1, BaseActivity.selGeoFeature, BaseActivity.myLayer);
                ...
                if (length1 > length2) {
                    ...
                    refeature = basePresenter.updateFeature(geometry2, BaseActivity.selGeoFeature, BaseActivity.myLayer);
                }
            }
        }
        return refeature;
