...
import com.otitan.gylyeq.dialog.LoginDialog;
import com.otitan.gylyeq.dialog.MobileInputDialog;
import com.otitan.gylyeq.entity.Bsuserbase;
import com.otitan.gylyeq.permission.PermissionsActivity;
import com.otitan.gylyeq.permission.PermissionsChecker;
...
//                }
    ...
    protected void onStart() {
        ...
        if(Build.VERSION.SDK_INT > 22){
            // 缺少权限时, 进入权限配置页面
            com.titan.baselibrary.permission.PermissionsActivity.initPermission(this, Constant.PERMISSIONS, com.titan.baselibrary.permission.PermissionsActivity.PERMISSIONS_REQUEST_CODE);
        }
