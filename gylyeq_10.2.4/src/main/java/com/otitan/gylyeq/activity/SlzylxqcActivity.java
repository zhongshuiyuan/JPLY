...
import com.otitan.gylyeq.dialog.SlzylxqcDialog;
import com.otitan.gylyeq.dialog.SlzylxqcYdwztDialog;
import com.otitan.gylyeq.dialog.SlzylxqcYindwztDialog;
...
public class SlzylxqcActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(sysname != null){
			sysname.setText(mContext.getResources().getString(R.string.lxqc_name));
		}
