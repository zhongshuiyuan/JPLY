    ...
    public void addLableToLayer(boolean isChecked, List<Field> fields, int position){
        ...
        for(long id : arrays){
            ...
            if(fields.get(position).getFieldType() == Field.esriFieldTypeDate){
                ...
                obj = feature.getAttributeValue(fields.get(position));
            }
            if(obj != null){

                PictureMarkerSymbol textSymbol = SymbolUtil.TextPicSymobel(mContext,obj.toString(),Color.BLUE,12, SymbolUtil.MODE.TOP);
                //TextSymbol textSymbol = new TextSymbol(20,obj.toString(), Color.BLUE);
                //设定之后可以使标注显示中文
//                String fontFamily = "DroidSansFallback.ttf";
//                final int aa = Build.VERSION.SDK_INT;
//                if(aa > 21){
//                    fontFamily = "DroidSansChinese.ttf";
//                }
