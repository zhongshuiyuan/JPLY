...
public class AttributeAdapter extends BaseAdapter {
	...
	private Map<String, Object> selectAttribute = new HashMap<>();
	private String currentLayerName = "当前图层";
	//private List<Map<String, String>> attrList= new ArrayList<>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (f.getAlias().contains("县") || f.getName().equals("xian") || f.getName().equals("XIAN") ) {
			if (obj != null) {
				xianD = obj.toString();
				if (domain != null) {
		...
		} else if (f.getAlias().contains("乡") || f.getName().equals("xiang") || f.getName().equals("XIANG")) {
			if (obj != null) {
				xiangD = obj.toString();
				if (domain != null) {
					strValue = domain.getCodedValues().get(obj);
		...
		} else if (f.getAlias().contains("村") || f.getName().equals("cun") || f.getName().equals("CUN")) {
			if (obj != null) {
				if (domain != null) {
					strValue = domain.getCodedValues().get(obj);
				} else {
