...
public class SetAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		for (Field f : lst) {
			...
			if (f.getAlias().contains("乡") || f.getName().equals("xiang") || f.getName().equals("XIANG")) {
				if (obj != null) {
					xiangD = obj.toString();
					if (domain != null) {
			...
			if (f.getAlias().contains("村") || f.getName().equals("cun") || f.getName().equals("CUN")) {
				if (obj != null) {
					if (domain != null) {
			...
			if (f.getAlias().contains("小班号") || f.getName().equals("xbh") || f.getName().equals("XBH")) {
				if (obj != null) {
					xbh = obj.toString();
				}
			}
