...
//                }
    ...
    private void sendDataToServer(String sysname,String tel,String dw,String retime,String sbmc,String sbh,String bz){
        Observable<String> observable = RetrofitHelper.getInstance(mContext).getServer().addMoblieSysInfo(sysname,sbh,tel);
        observable.subscribeOn(Schedulers.io())
                ...
                .subscribe(new Observer<String>() {
                    ...
                    public void onError(Throwable e) {
                        ToastUtil.setToast(mContext, "服务器错误");
                    }
