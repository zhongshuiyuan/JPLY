...
import com.titan.ycslzy.adapter.ShouCangAdapter;
import com.titan.ycslzy.db.DbHelperService;
import com.titan.ycslzy.entity.ShouCang;
...
public class ShouCangDialog extends Dialog implements View.OnClickListener {
	...
	public ShouCangDialog(Context context,ShouCang cang,SqlType type,DbHelperService<ShouCang> service,ShouCangAdapter adapter) {
		super(context, R.style.Dialog);
		this.context = context;
		this.sqlType = type;
		this.cang = cang;
