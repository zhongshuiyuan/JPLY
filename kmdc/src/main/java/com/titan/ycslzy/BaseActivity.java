...
import com.titan.ycslzy.dialog.MobileInputDialog;
import com.titan.ycslzy.dialog.RenderSetDialog;
import com.titan.ycslzy.dialog.ResultAreaDialog;
import com.titan.ycslzy.dialog.SceneInfoDialog;
...
import com.titan.ycslzy.entity.ScreenTool;
 ...
 * activity基类
 */
public abstract class BaseActivity extends Activity implements LayerSelectDialog.SetOnItemClickListener,RecyclerViewPicAdapter.PicOnclick,
    ...
    public SceneInfoDialog sceneInfoDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initGpsSettings();
        /*注册设备信息*/
        if(!MyApplication.hasRegist){
            showRegisterMinfoDialog();
        }
        /**/
        layerNameList.clear();
    ...
    public void initGraphicLocation() {
        ...
        Geometry geometry = GeometryEngine.buffer(currentPoint,SpatialReference.create(2343) , 20, null);
        circlePolygon =(Polygon) GeometryEngine.project(geometry,SpatialReference.create(2343),spatialReference);
                ...
                switch (drawType) {
                    ...
                    case FREEHAND_POLYLINE:
                        ...
                        if (size == 0) {
                            ...
                            Geometry geometry = GeometryEngine.project(polyline,spatialReference,SpatialReference.create(2343));
                            double d1 = geometry.calculateLength2D();
                            polyline.lineTo(point);
                            Geometry geometry2 = GeometryEngine.project(polyline,spatialReference,SpatialReference.create(2343));
                            double d2 = geometry2.calculateLength2D();
                            double d = d2 - d1;
                            if (d > 6) {
                                polyline_all.lineTo(point);
                            }
...
//		}
    ...
    /**设备信息注册*/
    public void showRegisterMinfoDialog(){
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case PICK_PHOTO://选择照片
                ...
                int mColumnWidth = ScreenTool.getScreenPix(mContext).getWidthPixels()/16;
                sceneInfoDialog.loadPhoto(sceneInfoDialog,picList, mColumnWidth,this);
                break;
            case TAKE_PHOTO:// 拍照
     ...
     * 巡检事件上报
     */
    public void showSceneInfoDialog(){
        sceneInfoDialog = new SceneInfoDialog(BaseActivity.this,R.style.Dialog, this);
        BussUtil.setDialogParams(mContext, sceneInfoDialog, 0.5, 0.65);
    }
