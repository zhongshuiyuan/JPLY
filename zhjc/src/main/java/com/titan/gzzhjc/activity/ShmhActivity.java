 ...
 * 石漠化
 */
public class ShmhActivity extends AppCompatActivity implements View.OnClickListener {

    ImageView mShmh_back;
    RadioButton rbShmhmj;
    RadioButton rbShmhzlmj;
    TextView tvTime;
    TextView tvContent;
    WebView shmhWebview;

    View childview;
    VHTableView shmhTabview;
    Echart echart;
    Context mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        childview = getLayoutInflater().inflate(R.layout.activity_shmh,null);
        setContentView(childview);

        mContext = ShmhActivity.this;
    ...
    private void initview() {
        ...
        mShmh_back = (ImageView) childview.findViewById(R.id.shmh_back);
        rbShmhmj = (RadioButton) childview.findViewById(R.id.rb_shmhmj);
        rbShmhzlmj = (RadioButton) childview.findViewById(R.id.rb_shmhzlmj);
        tvTime = (TextView) childview.findViewById(R.id.tv_time);
        tvContent = (TextView) childview.findViewById(R.id.tv_content);
        shmhWebview = (WebView) childview.findViewById(R.id.shmh_webview);

        mShmh_back.setOnClickListener(this);
        rbShmhmj.setOnClickListener(this);
        rbShmhzlmj.setOnClickListener(this);
        shmhTabview = (VHTableView)childview.findViewById(R.id.shmh_tabview);
    ...
    public void initWebview(){
        ...
        String type = getResources().getString(R.string.shmh);
        echart = optionImpl.initWebView(mContext, shmhWebview, type,handler);
        keyType = getResources().getString(R.string.shmhmj);
    ...
    public void onClick(View view) {
        ...
        } else if (i == R.id.rb_shmhmj) {
            gotoHtml(R.string.shmhmj);

        } else if (i == R.id.rb_shmhzlmj) {
            gotoHtml(R.string.shmhzlmj);
    ...
    public void reInitWebview(Button button){
        ...
        tvTime.setText(txt);
        shmhWebview.loadUrl("javascript:setchart('" + dbname + "');");
        popup.dismiss();
    }
    ...
    public void gotoHtml(int type){
        ...
        echart.setYwType(keyType);
        shmhWebview.loadUrl("javascript:setchart('" + mContext.getResources().getString(R.string.gzsh) + "');");
        changContent();
    }
